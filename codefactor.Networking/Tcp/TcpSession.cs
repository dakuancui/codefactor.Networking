...
namespace codefactor.Networking.Tcp
{
    ...
    public class TcpSession : IDisposable
    {
        ...
        internal void Connect(Socket socket)
        {
            ...
            // Setup buffers
            _receiveBuffer = new Application.Models.MessageBuffer();
            _sendBufferMain = new Application.Models.MessageBuffer();
            _sendBufferFlush = new Application.Models.MessageBuffer();
        ...
        private Application.Models.MessageBuffer _receiveBuffer;
        private SocketAsyncEventArgs _receiveEventArg;
        // Send buffer
        private readonly object _sendLock = new object();
        private bool _sending;
        private Application.Models.MessageBuffer _sendBufferMain;
        private Application.Models.MessageBuffer _sendBufferFlush;
